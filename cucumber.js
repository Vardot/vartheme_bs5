// Cucumber-js config for the Vartheme BS5 varbase-e2e suite.
//
...
// live in tests/step-definitions/vartheme_bs5.steps.js. Every worldParameter
  ...
  default: {
    ...
    worldParameters: {
      ...
      selectors: {
        ...
        files: ['cms-drupal-core-claro.json', 'vartheme_bs5.json'],
        offset: 60,
        breakpoints: {
