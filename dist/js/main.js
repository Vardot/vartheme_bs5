(() => {
  var __webpack_modules__ = {
    ...
    "./js/bootstrap.js": (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, {
  ...
  (() => {
    ...
    var _bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./js/bootstrap.js");
    document.querySelectorAll('[data-bs-toggle="tooltip"]').forEach((tooltipElement => new _bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip(tooltipElement))), 
    document.querySelectorAll(".toast").forEach((toastElement => new _bootstrap__WEBPACK_IMPORTED_MODULE_0__.Toast(toastElement)));
  })();
})();