...
2. Change directory in the terminal to `docroot/themes/contrib/vartheme_bs5/scripts`
3. Run the `create-new-vartheme-bs5.sh "THEME_NAME"`. Change the `THEME_NAME` to the project name or any selected theme name.
...
Change directory to `docroot/themes/contrib/vartheme_bs5/scripts`

```
cd /var/www/html/mysite/docroot/themes/contrib/vartheme_bs5/scripts
```

Run the following `bash`command to create a custom theme named "_mytheme"_ 

```
bash ./create-new-vartheme-bs5.sh "mytheme"
```
...
```
---------------------------------------------------------------------------
   The new Vartheme BS5 Sub-Theme were created at "/var/www/html/mysite/docroot/themes/custom/mytheme :)" 
---------------------------------------------------------------------------
```
...
Run it again ones after updating the **Bootstrap 5** library with `yarn install`
